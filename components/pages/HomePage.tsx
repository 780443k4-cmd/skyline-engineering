...
export default function HomePage() {
  ...
  return <>
    ...
    <section className="py-24 md:py-32"><div className="container-content">
      ...
      <div className="mt-12"><Link href={localizePath('/contact')} className="inline-block border border-ink px-8 py-4 text-xs tracking-widest2 uppercase hover:bg-ink hover:text-warmwhite transition-colors">{t.home.talk}</Link></div>
    </div></section>
    <section className="py-24 md:py-32 bg-white/50 border-y border-line"><div className="container-content">
      ...
      <div className="mt-8"><Link href={localizePath('/contact')} className="inline-block bg-skyline text-warmwhite px-8 py-4 text-xs tracking-widest2 uppercase hover:bg-skyline-light transition-colors">{t.home.estimate}</Link></div>
    </div></section>
